...
Build metadata exposes the package version through a Vite constant. The visible commit uses a bundled local fallback and may refresh from the public GitHub commits API at runtime when available.
